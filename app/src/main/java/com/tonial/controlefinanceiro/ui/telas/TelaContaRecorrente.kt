...
fun TelaContaRecorrente(
    ...
    TelaContaRecorrenteContent(
        modifier = modifier,
        descricao = viewModel.descricao,
        onDescricaoChange = { viewModel.onDescricaoChange(it) },
        valor = viewModel.valor,
        onValorChange = { viewModel.onValorChange(it) },
        data = viewModel.data,
        onDataChange = { viewModel.onDataChange(it) },
        categoriaId = viewModel.categoriaId,
        onCategoriaIdChange = { viewModel.onCategoriaIdChange(it) },
...
@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun TelaContaRecorrenteContent(
    modifier: Modifier = Modifier,
    descricao: String,
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                title = { Text(if (!isEditMode) "Nova Conta Recorrente" else "Editar Conta Recorrente") },
                navigationIcon = {
        ...
        Column(
            ...
            Row(
                ...
                OutlinedTextField(
                    ...
                    visualTransformation = CurrencyVisualTransformationRecorrente(),
...
private class CurrencyVisualTransformationRecorrente : VisualTransformation {
...
@Composable
fun TelaContaRecorrentePreview() {
